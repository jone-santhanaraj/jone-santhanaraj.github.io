...
To Locally View This Website:
Run The Batch File "Browser Sync.bat"
...
!!!
Opening the index.html directly will return Fetch Error as the program uses the fetch method to access the data in the JSON file.
!!!

---

For More Details Contact Me At:
Twitter: JoneSanthanaraj
